    ...
    public partial class AddCoreTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainerServiceMaps", x => new { x.TrainerId, x.ServiceId });
                    table.ForeignKey(
                        name: "FK_TrainerServiceMaps_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrainerServiceMaps_Trainers_TrainerId",
                        column: x => x.TrainerId,
                        principalTable: "Trainers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainerSpecialtyMaps", x => new { x.TrainerId, x.SpecialtyId });
                    table.ForeignKey(
                        name: "FK_TrainerSpecialtyMaps_Specialties_SpecialtyId",
                        column: x => x.SpecialtyId,
                        principalTable: "Specialties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrainerSpecialtyMaps_Trainers_TrainerId",
                        column: x => x.TrainerId,
                        principalTable: "Trainers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainerServiceMaps_ServiceId",
                table: "TrainerServiceMaps",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_TrainerSpecialtyMaps_SpecialtyId",
                table: "TrainerSpecialtyMaps",
                column: "SpecialtyId");
        }
